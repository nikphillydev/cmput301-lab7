...
public class MainActivityTest {
    ...
    public void testNavigateToShowActivity() {
        ...
        // Verify intent launched
        intended(hasComponent(ShowActivity.class.getName()));
    }

    @Test
    public void testCityNameConsistentWithShowActivity() {
        ...
        // Click on the added city item
        onData(is("Edmonton"))
                .inAdapterView(withId(R.id.city_list))
                .perform(click());

        // Verify displayed city name in ShowActivity is as expected
        onView(withId(R.id.city_textview)).check(matches(withText("Edmonton")));
    }
}
